...
type IconName = 'home' | 'calendar' | 'vote' | 'fileText' | 'book' | 'users' | 'archive' | 'dollarSign' | 'barChart2' | 'plus' | 'edit' | 'trash2' | 'save' | 'x' | 'fileUp' | 'folderPlus' | 'share' | 'download' | 'chevronDown' | 'search' | 'checkCircle' | 'xCircle' | 'alertCircle';
...
const icons: Record<IconName, React.FC<React.SVGProps<SVGSVGElement>>> = {
  ...
  barChart2: (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" x2="18" y1="20" y2="10"/><line x1="12" x2="12" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="14"/></svg>
  ),
  plus: (props) => (
  ...
  fileUp: (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M12 12v-6"/><path d="m9 9 3-3 3 3"/></svg>
  ),
  folderPlus: (props) => (
